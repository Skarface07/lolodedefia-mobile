...
const mockReviews = [
  { id: "r1", author: "Famille Kponou", note: 5, comment: "Très ponctuelle et attentionnée avec les enfants." },
  { id: "r2", author: "Entreprise Sika", note: 4, comment: "Bon travail, communication facile." },
];
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.md, paddingBottom: 100 }}>
        <View style={styles.profileHeader}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.rating}>{youth.rating} ({youth.reviews} avis)</Text>
          </View>
              ...
              <View style={styles.row}>
                ...
                <View style={{ flexDirection: "row", marginLeft: "auto" }}>
                  {Array.from({ length: r.note }).map((_, i) => (
                    <Ionicons key={i} name="star" size={11} color={colors.accentGold} />
                  ))}
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  badgeText: { fontSize: 11, color: colors.primary, fontWeight: "700", marginLeft: 4 },
  ...
  reviewCard: { backgroundColor: colors.background, borderRadius: radius.md, padding: spacing.sm, marginBottom: spacing.sm },
